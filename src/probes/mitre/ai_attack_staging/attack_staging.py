...
from probes.mitre.ai_attack_staging.generate_prompts import main as generate_prompts
...
class AttackStaging(AttackProbe):
    name = "attack_staging"
    mitre_category = "AI Attack Staging"
