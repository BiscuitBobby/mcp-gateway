...
from probes.mitre.user_execution.generate_prompts import main as generate_prompts
...
class UserExecution(AttackProbe):
    name = "user_execution"
    mitre_category = "User Execution"
